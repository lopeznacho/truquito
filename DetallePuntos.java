...
public class DetallesPuntos {
    ...
    /** Crea instancia de DetallesPuntos */
    ...
    protected EquipoTruco equipoGanador;
    protected JugadorTruco responsable;
    protected int puntosGanados;
    protected int ganadosPor;
    
    public DetallesPuntos(EquipoTruco tm, int gp, int pg) {
        equipoGanador = tm;
        puntosGanados = pg;
        ganadosPor = gp;
    }

    public DetallesPuntos (EquipoTruco tm, int gp, int pg, JugadorTruco responsable){
        this(tm,gp,pg);
